                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="search_form" method="post" >
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-2">部门名称</label>
                                        <div class="col-lg-10">
                                            <input style="width:200px;" class=" form-control" id="deptName" name="deptName" type="text" />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="newsletter" class="control-label col-lg-2 col-sm-3">父部门</label>
                                        <div class="col-lg-10 col-sm-9">
                                            <select style="width: 200px;height: 30px;" class="weui-select" name="parentid" id="parentid">
