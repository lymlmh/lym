...
function update(id){
	var userid=id;
		if(userid!='' && userid!=null){
			window.location.href="index/jueseupdate/index.do?id="+id;
		}else{
			alert("请选择需要修改的角色", "提示！");
		}
}
...
$(function(){
	$("#save").click(function(){
		window.location.href="index/juesesave/index.do";
	});
        ...
        <div class="wrapper">
             <div class="row">
                ...
                <header class="panel-heading">
                                      角色信息
               <button class="btn btn-success pull-right" type="button" id="fenpei" >角色分配</button>
               <button class="btn btn-success pull-right" type="button" id="save" >新增角色</button>
                </header>              
                ...
                <tbody>
                <c:forEach items="${juese}" var="item">
                <tr class="">
                    <td>${item.name}</td>
                    ...
                    <td><a  onclick="dele(${item.id})" href="javascript:;">删除</a></td>
                    <td><a  onclick="update(${item.id})" href="javascript:;">修改</a></td>
                </tr>
               </c:forEach>
