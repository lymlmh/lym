...
<body>
<div class="weui-cells__title">新增地点</div>
      <form action="#" method="get" >
    <div class="weui-cell weui-cell_vcode">
        <div class="weui-cell__hd">
          <label class="weui-label">地点名称</label>
        </div>
        <div class="weui-cell__bd">
          <input class="weui-input" type="text" name="name" placeholder="请输入地点名称" id="name">
        </div>
      </div>
    ...
    <div class="weui-btn-area">
	  ...
	  <div class="button_sp_area">
        <a href="javascript:;" id="delete" class="weui-btn weui-btn_mini weui-btn_default">删除地点</a>
      </div>
	<div class="bd">
      <div class="page__bd">
	        <div class="weui-cells__title">地点信息</div>
