...
$(function(){
	...
	$("#0").click(function(){
		window.location.href="flow/audit1.do?id="+id+"&aduitAdvice=0";
	});
	
	$("#1").click(function(){
		window.location.href="flow/audit1.do?id="+id+"&aduitAdvice=1";
	});
...
<body>
      ...
      <div class="weui-form-preview__bd">
       ...
       <div class="weui-form-preview__item">
          ...
          <span class="weui-form-preview__value">${fixedAssets.place}</span>
        </div>
        <div class="weui-form-preview__item">
          ...
          <span class="weui-form-preview__value"><fmt:formatDate value="${assetsFlow.applyTime}" pattern="yyyy/MM/dd  HH:mm:ss" /></span>
                  ...
                  <div class="weui-form-preview__item">
          <label class="weui-form-preview__label">转移部门</label>
          <span class="weui-form-preview__value">${deptname}</span>
        </div>
        
        <div class="weui-form-preview__item">
          <label class="weui-form-preview__label">转移对象</label>
          <span class="weui-form-preview__value" >${empname}</span>
        </div>
        
        <div class="weui-form-preview__item">
          <label class="weui-form-preview__label">转移地点</label>
          <span class="weui-form-preview__value" >${assetsFlow.place}</span>
        </div>
