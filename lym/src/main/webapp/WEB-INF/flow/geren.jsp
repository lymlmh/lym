...
/* 	$("#flows .weui-cell_access").click(function(){
		...
		window.location.href="flow/item.do?id="+id;
	}); */
});
...
<body>
 <div class="weui-search-bar" id="searchBar">
	...
	<div class="bd">
      <div class="page__bd">
	        <div class="weui-cells__title">审批结果</div>
		          ...
		          <div class="weui-cell">
		            ...
		            <c:choose>
					   ...
					   <c:when test="${item.auditStatus==1}"> 
					       <div class="weui-cell__ft" style="color:#000000">${item.auditStatusStr}</div>      
					   </c:when>
					   	<c:when test="${item.auditStatus==2}"> 
					       <div class="weui-cell__ft" style="color:#ff0000">${item.auditStatusStr}</div>      
					   </c:when>
					   <c:otherwise>
					  	   <div class="weui-cell__ft" style="color:rgb(0,0,255)">未审批</div>
					   </c:otherwise>
					</c:choose>
		          </div>            
	        </c:forEach>
