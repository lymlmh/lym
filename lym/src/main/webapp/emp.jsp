...
function update(userid){
	var userid=userid;
		if(userid!='' && userid!=null){
			window.location.href="index/empupdate/index.do?userid="+userid;
		}else{
			alert("请选择需要修改的员工", "提示！");
		}
}
...
$(function(){
	$("#save").click(function(){
		window.location.href="index/empsave/index.do";
	});
});
</script>
        ...
        <div class="wrapper">
             <div class="row">
                ...
                <header class="panel-heading">
                                      员工信息
               <button class="btn btn-success pull-right" type="button" id="save" >新增员工</button>
                </header>              
                ...
                <tr class="">
                    ...
                    <td><a  onclick="dele('${item.userid}')" href="javascript:;">删除</a></td>
                    <td><a  onclick="update('${item.userid}')" href="javascript:;">修改</a></td>
                </tr>
               </c:forEach>
